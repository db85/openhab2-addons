...
import static org.openhab.binding.parrotflower.ParrotFlowerBindingConstants.DATE_TIME_FORMAT;
...
final class StateConverterUtils {
    ...
    public static State toDateTimeType(@Nullable String value) {
        ...
        try {
            ...
            DateTimeFormatter parser = DateTimeFormatter.ofPattern(DATE_TIME_FORMAT).withZone(ZoneId.systemDefault());
